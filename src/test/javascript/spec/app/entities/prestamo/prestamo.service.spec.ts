...
describe('Service Tests', () => {
    ...
    describe('Prestamo Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(PrestamoService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/prestamos/' + 123);
            });
            it('should return Prestamo', () => {

                let entity: Prestamo;
                service.find(123).subscribe((_entity: Prestamo) => {
                    entity = _entity;
                });
